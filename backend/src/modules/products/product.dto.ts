...
export const updateProductSchema = z.object({
  ...
  displayName: z.string().min(2).max(200).trim().nullable().optional(),
  ...
  secondaryKeywords: z.string().max(500).nullable().optional(),
  imageAltText: z.string().max(200).nullable().optional(),
